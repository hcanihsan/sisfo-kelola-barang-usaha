    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-trasparent second-text active"><i class="ri-file-history-line text-light"></i><h6 class="text-light">Riwayat Penjualan</h6></a>
    ...
    <div class="container-fluid px-4">
        <div class="row g-3 my-2">
            <div class="d-flex align-items-center">
                <i class="ri-file-history-fill ri-2x" id="menu-toggle">
                </i><h2 class="fs-2 m-0">Riwayat Penjualan</h2>
            </div>            
        
            {{-- <div class="col-md-3">
                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                    <div>
                        <h3 class="fs-2">Rp 72.000.000</h3>
        ...
        <div class="row my-5">
            <h3 class="fs-4 mb-3">Daftar Riwayat Penjualan</h3>
        
           <form class="d-flex fs-4 mb-3" action="{{ url('historysell') }}" method="get">
                ...
                <table class="table bg-white rounded shadow-sm  table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->category}}</td>
                            <td>{{ $item->quantity}} Buah</td>
                            <td>{{ $item->rupiahFormat('totalprice') }}</td>
                            <td>
                                @if ($item->imgproduct)
                            ...
                            <td class="text-center">
                                <form onsubmit="return confirm('Ingin Menghapus Data Ini ?')" class="d-inline" action="{{ url('historysell/'.$item->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
